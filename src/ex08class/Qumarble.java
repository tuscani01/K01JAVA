...
class ChildProperty {
	...
	/*
	 디폴트생성자는 개발자가 생성자 정의하지 않았을때 자동으로 생성됨
	 */
	...
	public void showProperty() {
		System.out.println("보유구슬개수"+ beadCnt);
	}
	public void obtainBead(ChildProperty child, int bCnt) 
	{
		//게임 승리 어린이 메소드 호출 주체
		this.beadCnt += bCnt;
		//매개변수로 전달된 어린이객체는 게임에패배한 구슬 bCnt만큼 차감해야함
		child.beadCnt -= bCnt;
	}
}
public class Qumarble
{
...
public static void main(String[] args)
{     
	ChildProperty ch3 = new ChildProperty();
